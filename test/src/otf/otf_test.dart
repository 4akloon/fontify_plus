...
void main() {
  ...
  group('OpenTypeFont table getters', () {
    test(
      'resolve to their concrete table types for an OpenType (CFF) font',
      () {
        final font = _buildFont();
  ...
  group('OpenTypeFont.size', () {
    test(
      ...
      () {
        ...
        final expectedTableListSize = font.tableMap.values.fold<int>(
          0,
          (p, t) => p + getPaddedTableSize(t.size),
        );
