...
import 'package:fontify_plus/src/otf/cff/char_string_operator.dart' as ops
    show escape;
...
void main() {
  group('char string operator constants', () {
    ...
    test('every named operator except vstem-adjacent ones has a display name',
        () {
      ...
      for (final operator in named) {
        expect(charStringOperatorNames.containsKey(operator), isTrue,
